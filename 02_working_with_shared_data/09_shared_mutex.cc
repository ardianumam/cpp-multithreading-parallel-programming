...
void write()
{
	std::lock_guard<std::shared_mutex> lck_guard(shmut); // wrap shared mutex to lock_guard to have exclusive mutex
...
void read()
{
	std::shared_lock<std::shared_mutex> lck_guard(shmut); // wrap shared mutex to lock_guard to have shared mutex
